...
public class VerifyOtpActivity extends AppCompatActivity {
    ...
    private CollectionReference userRef, sellerRef;
    ...
    private void updateUserDetails() {
        ...
        FirebaseInstanceId.getInstance().getInstanceId().addOnCompleteListener(new OnCompleteListener<InstanceIdResult>() {
            ...
            public void onComplete(@NonNull Task<InstanceIdResult> task) {
                ...
                userData.clear();
                userData.put("sellerID", currentUserID);
                userData.put("sellerName", mName);
                userData.put("sellerPhone", mPhoneNumber);
                userData.put("sellerEmail", mEmail);
                userData.put("sellerDeviceToken", token);

                sellerRef.document(currentUserID).set(userData).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this, CHANNEL_ID)
                        ...
                        .setContentText("Welcome to the Fresh Fish Community." +
                                "\nOrder now and get fresh fish delivered right to you door!.")

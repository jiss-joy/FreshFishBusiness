...
public class ConsumerOrdersFragment extends Fragment implements AdapterShortOrder.OnOrderClickListener {
    ...
    private void setUpToolbar() {
        ...
        toolbar.setTitle("Consumer Orders");
        ...
        orderRef.orderBy("orderStatus", Query.Direction.ASCENDING).addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                for (DocumentSnapshot documentSnapshot : value.getDocuments()) {
                    if (documentSnapshot.getString("orderSellerID").equals(user.getUid())) {
                ...
                if (orderList.isEmpty()) {
                    ...
                    noOrderTV.setText("You do not have any orders. \n Please put a fish post in the market now!");
                } else {
    ...
    public void onOrderClick(int position) {
        ...
        Intent intent = new Intent(getActivity(), FullOrderDetailsActivity.class);
